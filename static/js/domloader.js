    ...
    init_loading_page: function () {
        if (this.loading_page === false) {
            ...
            if (domloader.icon !== false) {
                $('#domloader_loading_show').append('<div style="text-align:center;margin-bottom:20px;"><img src="../Bootstrap4 - 中文文档 - 让我们开始吧_files/' + domloader.icon + '" style="vertical-align: middle;border-style: none;width:129px;height:129px;"/></div>');
            }
